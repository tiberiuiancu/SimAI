...
_APEX_CACHE_DIR = Path.home() / ".cache" / "simai" / "apex"

_DEEPGEMM_GIT_URL = "https://github.com/deepseek-ai/DeepGEMM.git"
_DEEPGEMM_CACHE_DIR = Path.home() / ".cache" / "simai" / "DeepGEMM"
...
def apex(
    ...
    install_cmd = [
        ...
        f'APEX_PARALLEL_BUILD=$(nproc) '
        f'APEX_CPP_EXT=1 APEX_CUDA_EXT=1 APEX_FAST_LAYER_NORM=1 '
        f'pip install -v --no-build-isolation .'
    ]
